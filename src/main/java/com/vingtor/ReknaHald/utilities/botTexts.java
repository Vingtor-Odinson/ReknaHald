package com.vingtor.ReknaHald.utilities;

public class botTexts {

    static public String helloKey = "/ola";

    static public String helpKey = "/ajuda";
    ...
    static public String syntaxError = "Os dados informados não seguem a sintaxe padrão do comando";

    static public String didntUnderstand ="Não entendi, tente /ola ou /ajuda";
}
